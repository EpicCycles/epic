...
import {movePartTypeToBottom} from '../../helpers/framework';

describe('movePartTypeToBottom tests', () => {
    it('does not fail if a section id is not found', () => {
        ...
        const newSections = movePartTypeToBottom(sections, 33, 971);
    ...
    it('does not fail if the part type is not found in the section', () => {
        ...
        const newSections = movePartTypeToBottom(sections, 33, 331);
        expect(newSections).toBe(sections);
    });
    it('moves found part type', () => {
        ...
        const newSections = movePartTypeToBottom(sections, 33, 332);
