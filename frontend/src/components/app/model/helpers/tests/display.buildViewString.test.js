...
describe('buildViewString', () => {
    ...
    it('should return bike name when a bike is passed that is found', () => {
        ...
        expect(buildViewString(model, field, sections, brands, suppliers, undefined, sampleBikes, sampleFrames)).toBe(expectedBike);
    })
    it('should return customer name when a customer is passed that is found', () => {
        ...
        const expectedBike = getBikeName(58, sampleBikes, sampleFrames);
        expect(buildViewString(model, field, sections, brands, suppliers, customers, sampleBikes, sampleFrames)).toBe('Bob');
    })
});