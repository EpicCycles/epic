...
class FrameHelperTestCase(TestCase):
    def setUp(self):
    ...
    def test_frame_display_with_no_parts(self):
        self.assertEqual([], frame_display(self.frame2))

    def test_frame_display_with_parts(self):
        expected_display = [str(self.frame_part3), str(self.frame_part2), str(self.frame_part1)]
        self.assertEqual(expected_display, frame_display(self.frame1))
