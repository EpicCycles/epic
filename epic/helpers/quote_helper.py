        ...
        if quote_answer.question.charge:
            if not QuoteCharge.objects.filter(quote=quote_answer.quote, charge=quote_answer.question.charge).exists():
                ...
                if quote_answer.question.charge.percentage:
                    quote_total = quote_answer.quote.calculated_price + quote_answer.quote.fixed_price_total
                    if quote_answer.quote.quote_price:
                        quote_total = quote_answer.quote.quote_price + quote_answer.quote.fixed_price_total
